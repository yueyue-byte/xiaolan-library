...
if (bookCount.count === 0) {
    ...
    // 示例5本（实际上可按原150本替换）
        ...
        // ----- 新增 50 本书开始 -----
        ['book151', '也许你该找个人聊聊', '洛莉·戈特利布', '9787513349831', 'available', ''],
        ['book152', '克拉拉与太阳', '石黑一雄', '9787532786828', 'available', ''],
        ['book153', '消失的13级台阶', '高野和明', '9787532786323', 'available', ''],
        ['book154', '字母表谜案', '大山诚一郎', '9787532787429', 'available', ''],
        ['book155', '沉默的巡游', '东野圭吾', '9787544291448', 'available', ''],
        ['book156', '希望之线', '东野圭吾', '9787544291455', 'available', ''],
        ['book157', '祈念守护人', '东野圭吾', '9787544291462', 'available', ''],
        ['book158', '无名之町', '东野圭吾', '9787544291479', 'available', ''],
        ['book159', '透明的螺旋', '东野圭吾', '9787544291486', 'available', ''],
        ['book160', '白鸟与蝙蝠', '东野圭吾', '9787544291493', 'available', ''],
        ['book161', '人生海海', '麦家', '9787559633024', 'available', ''],
        ['book162', '文城', '余华', '9787530219874', 'available', ''],
        ['book163', '月光武士', '虹影', '9787559661058', 'available', ''],
        ['book164', '燕食记', '葛亮', '9787559668361', 'available', ''],
        ['book165', '宝水', '乔叶', '9787515392947', 'available', ''],
        ['book166', '本巴', '刘亮程', '9787559645416', 'available', ''],
        ['book167', '千里江山图', '孙甘露', '9787544863524', 'available', ''],
        ['book168', '金色河流', '鲁敏', '9787544880095', 'available', ''],
        ['book169', '北流', '林白', '9787544890735', 'available', ''],
        ['book170', '长安的荔枝', '马伯庸', '9787572609275', 'available', ''],
        ['book171', '太白金星有点烦', '马伯庸', '9787572609282', 'available', ''],
        ['book172', '龙与地下铁', '马伯庸', '9787559634304', 'available', ''],
        ['book173', '显微镜下的大明', '马伯庸', '9787559625944', 'available', ''],
        ['book174', '两京十五日', '马伯庸', '9787559623582', 'available', ''],
        ['book175', '大医·破晓篇', '马伯庸', '9787572607646', 'available', ''],
        ['book176', '大医·日出篇', '马伯庸', '9787572607653', 'available', ''],
        ['book177', '古董局中局', '马伯庸', '9787559606444', 'available', ''],
        ['book178', '风起陇西', '马伯庸', '9787559600848', 'available', ''],
        ['book179', '三国配角演义', '马伯庸', '9787559603566', 'available', ''],
        ['book180', '草原动物园', '马伯庸', '9787559609636', 'available', ''],
        ['book181', '七侯笔录', '马伯庸', '9787559609926', 'available', ''],
        ['book182', '四海鲸骑', '马伯庸', '9787559615600', 'available', ''],
        ['book183', '长安十二时辰', '马伯庸', '9787559611657', 'available', ''],
        ['book184', '唐朝诡事录', '魏风华', '9787559630016', 'available', ''],
        ['book185', '酉阳杂俎', '段成式', '9787540247388', 'available', ''],
        ['book186', '搜神记', '干宝', '9787540247395', 'available', ''],
        ['book187', '聊斋志异', '蒲松龄', '9787540247401', 'available', ''],
        ['book188', '阅微草堂笔记', '纪昀', '9787540247418', 'available', ''],
        ['book189', '子不语', '袁枚', '9787540247425', 'available', ''],
        ['book190', '夜航船', '张岱', '9787540247432', 'available', ''],
        ['book191', '陶庵梦忆', '张岱', '9787540247449', 'available', ''],
        ['book192', '西湖梦寻', '张岱', '9787540247456', 'available', ''],
        ['book193', '浮生六记', '沈复', '9787540247463', 'available', ''],
        ['book194', '影梅庵忆语', '冒襄', '9787540247470', 'available', ''],
        ['book195', '香畹楼忆语', '陈裴之', '9787540247487', 'available', ''],
        ['book196', '秋灯琐忆', '蒋坦', '9787540247494', 'available', ''],
        ['book197', '寄心琐语', '余其锵', '9787540247500', 'available', ''],
        ['book198', '项脊轩志', '归有光', '9787540247517', 'available', ''],
        ['book199', '与妻书', '林觉民', '9787540247524', 'available', ''],
        ['book200', '曾国藩家书', '曾国藩', '9787540247531', 'available', '']
    ];
